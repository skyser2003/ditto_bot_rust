...
lazy_static! {
    ...
    static ref MHW_DATA: Vec<slack::MonsterHunterData<'static>> = vec![
        slack::MonsterHunterData {
            ...
            text: "도도가마루",
            image_url: "https://github.com/skyser2003/ditto_bot_rust/blob/master/images/Dodogama.png"
        },
        slack::MonsterHunterData {
            keywords: vec!["ㅊㅊ", "추천"],
            text: "치치야크",
            image_url: "https://github.com/skyser2003/ditto_bot_rust/blob/master/images/Tzitzi_Ya_Ku.png"
        },
        slack::MonsterHunterData {
            keywords: vec!["ㅈㄹ", "지랄"],
            text: "조라마그다라오스",
        ...
        slack::MonsterHunterData {
            keywords: vec!["ㄹㅇ", "리얼"],
            text: "로아루드로스",
            image_url: "https://github.com/skyser2003/ditto_bot_rust/blob/master/images/Royal_Ludroth.png"
        },
        slack::MonsterHunterData {
            keywords: vec!["ㅇㄷ"],
            text: "오도가론",
            image_url: "https://github.com/skyser2003/ditto_bot_rust/blob/master/images/Odogaron.png"
        },
        slack::MonsterHunterData {
            keywords: vec!["이불", "졸려", "잘래", "잠와", "이블조"],
            text: "이블조",
            image_url: "https://github.com/skyser2003/ditto_bot_rust/blob/master/images/Evil_Jaw.png"
        },
    ];
